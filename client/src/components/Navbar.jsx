...
// below is for heart next to logo in navbar - check react icons for your own
import {GiRayGun, GiTechnoHeart} from 'react-icons/gi';
  ...
  return (
    ...
    <Box bg={useColorModeValue('gray.100', 'gray.900')} px={4}>
            ...
            <HStack>
                <Link as={ReactLink} to='/ '>
                    <Flex alignItems= 'center'>
                        ...
                        <Text fontWeight='extrabold'>NoNonScentsSoaps</Text>
                    </Flex>
                </Link>
        ...
        <Button as={ReactLink} to='/login' p={2} fontSize='sm' fontWeight={400} variant='link'>
                Sign In</Button>
            <Button as={ReactLink} to='/registration' 
            m={2} 
